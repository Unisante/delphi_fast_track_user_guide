...
The steps below will allow the scripts to automatically retrieve your personal tokens corresponding to your REDCap project, for each of the 2 rounds (dft2 and dft3), whilst avoiding sharing them.
