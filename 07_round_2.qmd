...
The number of sections and of each type of questions in them will vary between projects.

The list of sections need to be defined manually in `000_parameters.R`.
...
It automatically calls `./code/dft2/01c_dft2_define_cols.R` and for each section `./analysis/dft2/dft2_child_section.Rmd`, which will create tables for each type of questions that are in the section (conditional for loop), by running two codes:
...
It will then call for each section `./analysis/dft2/dft2_child_section.Rmd`, which will create tables for each type of questions that are in the section (conditional for loop), by running two codes: 
