...
-   Code only [doi: 10.16909/dataset/40](https://doi.org/10.16909/dataset/40)

-   Demonstration set (code, anonymized dataset and outputs) [doi: 10.16909/dataset/41](https://doi.org/10.16909/dataset/41)

-   User guide [doi: 10.16909/dataset/39](https://doi.org/10.16909/dataset/39)
...
1.  Velarde Crézé C, Lebon L, Duperrex O, Faivre V, Pasche M, Cornuz J. Cigarettes électroniques jetables de type puffs : consensus d'expert-e-s sur leur réglementation. Poster presented at: 16e Congrès de la Société Francophone de Tabacologie; 2022 Nov 24-25; Dijon, France. Available from: <http://csft2022.fr/>
...
1.  Velarde Crézé C, Duperrex O, Lebon L, Faivre V, Pasche M, Cornuz J. A fast-track Delphi process to timely support public health-related policy decisions in a crisis context. (in preparation)
