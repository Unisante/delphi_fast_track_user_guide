...
-   [ ] Within your [**`REDCap`**](https://projectredcap.org/) "round 2" project: **replace all "xxx" with the texts of your actual statements and answer options**. Duplicate type 1, 2 and/or 3 questions' "skeleton" based on your needs, i.e., the number of sections and types of questions per section that you wish to include in this e-questionnaire
