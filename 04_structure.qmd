...
> **TODO:** revise structure with latest versions

The demo shows a project when it is finished. Below you'll find the detail of the structure when you start your own project and what will be added by the end.
...
├── delphi_ft.Rproj
└── texts_intro
    ├── .. several introductory texts *.docx
```
